      ...
      <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
          ...
          <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
                <div>
                    <h6 class="my-0"></h6>
                    <small class="text-muted"><?= $item['name'] ?><span class="mx-2">X</span> <?= $item['num'] ?></small>
                </div>
                <span class="text-muted">$<?= $item['price'] * $item['num'] ?></span>
            </li>
            <?php endforeach; ?>
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate>
            ...
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Bill</button>
          </form>
        </div>
      </div>
